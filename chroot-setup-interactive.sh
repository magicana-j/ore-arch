...
# Wayland native applications use input-method-v2 protocol directly.
# GTK_IM_MODULE and QT_IM_MODULE are only needed for X11 or legacy apps.
# Uncomment the lines below if GTK3/Qt5 apps do not recognize fcitx5.

# GTK_IM_MODULE=fcitx
# QT_IM_MODULE=fcitx

# Required for XWayland applications
XMODIFIERS=@im=fcitx
EOF
